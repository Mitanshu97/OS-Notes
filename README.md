...
This repository contains documentation regarding all the important OS concepts and notes from the Operating Systems course [Introduction to Operating Systems](https://www.udacity.com/course/introduction-to-operating-systems--ud923) at Udacity. The repo contains summarized information and key points regarding the main OS concepts. 
